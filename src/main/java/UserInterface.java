...
public class UserInterface {
    ...
    public void run() {
        ...
        System.out.println("""
                               _______  _______  _______ _________ _        _______    _______  ______            _______  _       _________          _______  _______\s
                              (  ____ \\(  ___  )(  ____ \\\\__   __/( \\      (  ____ \\  (  ___  )(  __  \\ |\\     /|(  ____ \\( (    /|\\__   __/|\\     /|(  ____ )(  ____ \\
                              | (    \\/| (   ) || (    \\/   ) (   | (      | (    \\/  | (   ) || (  \\  )| )   ( || (    \\/|  \\  ( |   ) (   | )   ( || (    )|| (    \\/
                              | |      | (___) || (_____    | |   | |      | (__      | (___) || |   ) || |   | || (__    |   \\ | |   | |   | |   | || (____)|| (__   \s
                              | |      |  ___  |(_____  )   | |   | |      |  __)     |  ___  || |   | |( (   ) )|  __)   | (\\ \\) |   | |   | |   | ||     __)|  __)  \s
                              | |      | (   ) |      ) |   | |   | |      | (        | (   ) || |   ) | \\ \\_/ / | (      | | \\   |   | |   | |   | || (\\ (   | (     \s
                              | (____/\\| )   ( |/\\____) |   | |   | (____/\\| (____/\\  | )   ( || (__/  )  \\   /  | (____/\\| )  \\  |   | |   | (___) || ) \\ \\__| (____/\\
                              (_______/|/     \\|\\_______)   )_(   (_______/(_______/  |/     \\|(______/    \\_/   (_______/|/    )_)   )_(   (_______)|/   \\__/(_______/""");
        welcomeMessage();
        while (run) {
